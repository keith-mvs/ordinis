#!/usr/bin/env python3
"""Create clean, properly formatted Python files for the skill package."""

# This script creates the properly formatted strategy_calculator.py and black_scholes.py

strategy_calc_content = '''#!/usr/bin/env python3
