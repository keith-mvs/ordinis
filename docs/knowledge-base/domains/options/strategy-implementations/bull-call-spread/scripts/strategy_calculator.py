...
class StrategyAnalyzer:
    ...
    def print_comprehensive_analysis(self):
        ...
        print(f"  Delta:    {greeks['delta']:>10.2f}  (Position move per $1 underlying)")
        print(f"  Gamma:    {greeks['gamma']:>10.4f}  (Delta change per $1 move)")
        print(f"  Theta:    {greeks['theta']:>10.2f}  (Daily time decay)")
        print(f"  Vega:     {greeks['vega']:>10.2f}  (Value per 1% IV change)")
        print(f"  Rho:      {greeks['rho']:>10.2f}  (Value per 1% rate change)")
