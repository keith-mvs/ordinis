# Long Call Butterfly - Strategy Mechanics

**Parent**: [Long Call Butterfly](../SKILL.md) | **Related**: [Quickstart](quickstart.md) | [Greeks Analysis](greeks-analysis.md)

---

## Position Structure

The long call butterfly consists of multiple option legs working together to create a specific risk/reward profile.
