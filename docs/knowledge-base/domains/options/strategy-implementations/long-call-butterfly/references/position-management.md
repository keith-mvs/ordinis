# Long Call Butterfly - Position Management

**Parent**: [Long Call Butterfly](../SKILL.md) | **Related**: [Strategy Mechanics](strategy-mechanics.md) | [Greeks Analysis](greeks-analysis.md)

---

## Management Philosophy

Effective position management separates profitable traders from the rest. For long call butterfly positions, disciplined management is essential.
