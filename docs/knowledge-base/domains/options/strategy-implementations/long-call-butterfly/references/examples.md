# Long Call Butterfly - Examples

**Parent**: [Long Call Butterfly](../SKILL.md) | **Related**: [Quickstart](quickstart.md) | [Position Management](position-management.md)

---

## Real-World Long Call Butterfly Examples
