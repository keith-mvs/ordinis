# Long Strangle - Iv Analysis

**Parent**: [Long Strangle](../SKILL.md) | **Related**: [Strategy Mechanics](strategy-mechanics.md) | [Earnings Plays](earnings-plays.md)

---

## Implied Volatility Analysis for Long Strangle

For long strangle positions, implied volatility (IV) is arguably the most important factor. Understanding IV rank, percentile, and expected move is essential for success.
...
- **50-75**: Moderate to high IV (good for Long Strangle)
...
If IV < Realized Vol:
  ...
  → Consider buying premium (Long Strangle)
```
...
- Enter Long Strangle when IV elevated and likely to realize
