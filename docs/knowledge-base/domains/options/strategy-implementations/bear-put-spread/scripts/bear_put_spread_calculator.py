...
class BearPutSpread:
    ...
    def print_analysis(self):
        ...
        print(f"  Gamma:    {analysis['greeks']['gamma']:>10.4f}  (Delta change per $1 move)")
        print(f"  Theta:    {analysis['greeks']['theta']:>10.2f}  (Daily time decay)")
        print(f"  Vega:     {analysis['greeks']['vega']:>10.2f}  (Value per 1% IV change)")
        print(f"  Rho:      {analysis['greeks']['rho']:>10.2f}  (Value per 1% rate change)")
        print()
