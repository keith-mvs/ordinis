...
**Parent**: [Iron Condor](../SKILL.md) | **Related**: [Quickstart](quickstart.md) | [Greeks Analysis](greeks-analysis.md)

---

## Position Structure

The iron condor consists of multiple option legs working together to create a specific risk/reward profile.
