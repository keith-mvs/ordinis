...
def bond_price_from_ytm(
    params: BondParameters, yield_to_maturity: float, settlement_date: datetime | None = None
) -> BondPrice:
    """
    ...
    accrued_interest = calculate_accrued_interest(params, settlement_date)
...
def calculate_accrued_interest(
    ...
    last_coupon_date: datetime | None = None,
...
def zero_coupon_bond_price(
    face_value: float, years_to_maturity: float, yield_to_maturity: float
) -> float:
    """
...
def callable_bond_price_estimate(
    params: BondParameters, yield_to_maturity: float, call_price: float, years_to_call: float
) -> dict:
    """
...
def validate_against_market(
    params: BondParameters, market_price: float, market_ytm: float, tolerance: float = 0.01
) -> dict:
    """
