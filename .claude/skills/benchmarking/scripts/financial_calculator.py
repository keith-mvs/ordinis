...
class FinancialCalculator:
    ...
    @staticmethod
    def net_profit_margin(data: FinancialData) -> Optional[float]:
    ...
    @staticmethod
    def roe(data: FinancialData) -> Optional[float]:
    ...
    @staticmethod
    def roa(data: FinancialData) -> Optional[float]:
    ...
    @staticmethod
    def asset_turnover(data: FinancialData) -> Optional[float]:
    ...
    @staticmethod
    def revenue_per_employee(data: FinancialData) -> Optional[float]:
...
class ValuationCalculator:
    ...
    @staticmethod
    def ps_ratio(data: FinancialData) -> Optional[float]:
    ...
    @staticmethod
    def pb_ratio(data: FinancialData) -> Optional[float]:
    ...
    @staticmethod
    def ev_revenue(data: FinancialData) -> Optional[float]:
    ...
    @staticmethod
    def ev_ebitda(data: FinancialData) -> Optional[float]:
    ...
    @staticmethod
    def ev_fcf(data: FinancialData) -> Optional[float]:
...
def calculate_all_metrics(data: FinancialData) -> Dict[str, Optional[float]]:
...
def calculate_cagr(ending: float, beginning: float, years: float) -> Optional[float]:
