...
class MultiLegStrategy:
    ...
    def max_profit(self, price_range: Optional[np.ndarray] = None) -> Tuple[float, float]:
        """
    ...
    def max_loss(self, price_range: Optional[np.ndarray] = None) -> Tuple[float, float]:
        """
    ...
    def breakeven_points(self, price_range: Optional[np.ndarray] = None) -> List[float]:
        """
