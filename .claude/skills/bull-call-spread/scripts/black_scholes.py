...
class BlackScholes:
    ...
    @staticmethod
    def call_theta(S: float, K: float, T: float, r: float, sigma: float, annual: bool = False) -> float:
    ...
    @staticmethod
    def put_theta(S: float, K: float, T: float, r: float, sigma: float, annual: bool = False) -> float:
    ...
    def calculate_all_greeks(S: float, K: float, T: float, r: float, sigma: float, option_type: str = 'call') -> Dict[str, float]:
        ...
        return {
            ...
            'delta': BlackScholes.call_delta(S, K, T, r, sigma) if is_call else BlackScholes.put_delta(S, K, T, r, sigma),
            'gamma': BlackScholes.gamma(S, K, T, r, sigma),
            'theta': BlackScholes.call_theta(S, K, T, r, sigma) if is_call else BlackScholes.put_theta(S, K, T, r, sigma),
            'vega': BlackScholes.vega(S, K, T, r, sigma),
            'rho': BlackScholes.call_rho(S, K, T, r, sigma) if is_call else BlackScholes.put_rho(S, K, T, r, sigma)
        }
