# Protective Collar - Strategy Mechanics

**Parent**: [Protective Collar](../SKILL.md) | **Related**: [Quickstart](quickstart.md) | [Greeks Analysis](greeks-analysis.md)

---

## Position Structure

The protective collar consists of multiple option legs working together to create a specific risk/reward profile.
