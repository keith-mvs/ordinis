# Protective Collar - Examples

**Parent**: [Protective Collar](../SKILL.md) | **Related**: [Quickstart](quickstart.md) | [Position Management](position-management.md)

---

## Real-World Protective Collar Examples
