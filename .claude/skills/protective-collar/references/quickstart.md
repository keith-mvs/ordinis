# Protective Collar - Quickstart

**Parent**: [Protective Collar](../SKILL.md) | **Related**: [Strategy Mechanics](strategy-mechanics.md) | [Examples](examples.md)

---

## Overview

The protective collar is a stock + options strategy. It is designed for traders with a protective market outlook.

**Key Characteristics**:
- Protective directional bias
...
**Market Outlook**: Protective with clear price targets
