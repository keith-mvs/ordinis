...
def compare_expirations(stock_price: float,
                       shares: int,
                       put_strike: float,
                       premiums_30d: float,
                       premiums_60d: float,
    ...
    pos_30d = MarriedPut(stock_price, shares, put_strike, premiums_30d, 
                         transaction_cost, days_to_expiration=30)
    pos_60d = MarriedPut(stock_price, shares, put_strike, premiums_60d, 
                         transaction_cost, days_to_expiration=60)
    pos_90d = MarriedPut(stock_price, shares, put_strike, premiums_90d, 
                         transaction_cost, days_to_expiration=90)
    ...
    monthly_costs = {
        '30d': monthly_cost_30d,
        '60d': monthly_cost_60d,
        '90d': monthly_cost_90d
    }
...
def calculate_roll_timing(current_days_remaining: int,
                          expiration_cycle: str = '60d') -> Dict:
    """
...
def estimate_premium_by_expiration(base_premium: float,
                                   base_days: int,
                                   target_days: int,
                                   theta_decay_rate: float = 0.40) -> float:
    """
