...
class MarriedPut:
    ...
    def max_loss(self) -> float:
        ...
        """
        loss_per_share = (
            (self.stock_price - self.put_strike)
            + self.put_premium
            + (self.transaction_cost / self.shares)
        )
    ...
    @property
    def annualized_protection_cost(self) -> float | None:
        """
    ...
    def __str__(self) -> str:
        ...
        return (
            f"MarriedPut(stock=${self.stock_price:.2f}, "
...
def calculate_optimal_strike(
    ...
    analysis = []
    for strike, premium in zip(available_strikes, available_premiums, strict=False):
