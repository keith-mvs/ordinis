...
class BudgetVsActualModel:
    ...
    def _create_summary_sheet(self):
        ...
        for line in revenue_lines:
            ...
            actual_cell.fill = PatternFill(start_color=self.COLORS['input'], 
        ...
        ws[f'F{row}'] = (f'=IF(E{row}>=0.05, "Favorable", '
                        f'IF(E{row}<=-0.05, "Unfavorable", "On Target"))')
    ...
    def _create_detail_sheet(self):
        ...
        ws['A3'] = ('This sheet provides detailed analysis of significant '
                   'variances (>5% or >$50K)')
        
        # Headers
        headers = ['Line Item', 'Budget', 'Actual', 'Variance ($)', 
                  'Variance (%)', 'Explanation', 'Action Required']
        for col, header in enumerate(headers, 1):
    ...
    def _create_variance_analysis(self):
        ...
        ws['A10'] = ('Review Detail sheet for explanation of significant '
                    'variances (>5% or >$50K)')
...
def create_budget_vs_actual_model(
    ...
    actual_revenue: Optional[Dict[str, float]] = None,
    actual_expenses: Optional[Dict[str, float]] = None,
    ...
    if output_path is None:
        output_path = (f'/mnt/user-data/outputs/{company_name.replace(" ", "_")}'
