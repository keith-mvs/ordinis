...
class ThreeStatementModel:
    ...
    def __init__(
        self, company: CompanyProfile, assumptions: ModelAssumptions, projection_years: int = 5
    ):
        """
    ...
    def _create_cover_sheet(self):
        ...
        metadata = [
            (
                "Model Purpose:",
                "Integrated financial projections with balance sheet, "
    ...
    def _create_assumptions_sheet(self):
        ...
        revenue_assumptions = [
            (
                "Base Year Revenue",
                self.assumptions.base_revenue,
                self.company.currency + " Millions",
                "Historical",
                "High",
            ),
            (
                "Revenue Growth Rate",
                self.assumptions.revenue_growth_rate,
                "Percentage",
                "Market forecast",
                "High",
            ),
        ...
        cost_assumptions = [
            (
                "COGS as % Revenue",
                self.assumptions.cogs_percent_revenue,
                "Percentage",
                "Historical average",
                "Medium",
            ),
            (
                "OpEx as % Revenue",
                self.assumptions.opex_percent_revenue,
                "Percentage",
                "Historical average",
                "Medium",
            ),
            (
                "Depreciation as % PP&E",
                self.assumptions.depreciation_percent_ppe,
                "Percentage",
                "Asset life analysis",
                "Low",
            ),
        ...
        wc_assumptions = [
            (
                ...
                self.assumptions.days_sales_outstanding,
                "Days",
                "Historical AR analysis",
                "Medium",
            ),
            (
        ...
        capital_assumptions = [
            (
                "Target Cash % Revenue",
                self.assumptions.target_cash_percent_revenue,
                "Percentage",
                "Liquidity policy",
                "Medium",
            ),
            (
                "CapEx % Revenue",
                self.assumptions.capex_percent_revenue,
                "Percentage",
                "Capital plan",
                "High",
            ),
            (
                ...
                self.assumptions.interest_rate_debt,
                "Percentage",
                "Current borrowing rate",
                "Medium",
            ),
            ("Tax Rate", self.assumptions.tax_rate, "Percentage", "Statutory rate", "Low"),
            (
                "Dividend Payout Ratio",
                self.assumptions.dividend_payout_ratio,
                "Percentage",
                "Dividend policy",
                "Low",
            ),
    ...
    def _create_income_statement(self):
        ...
        for year in range(self.projection_years + 1):
            ...
            ws[f"{col}12"] = f"=-('Balance Sheet'!{col}14+'Balance Sheet'!" f"{col}15)*InterestRate"
    ...
    def _create_balance_sheet(self):
        ...
        for year in range(1, self.projection_years + 1):
            ...
            ws[f"{col}23"] = f"={prev_col}23+'Income Statement'!{col}15" f"-'Cash Flow'!{col}27"
        ...
        for year in range(self.projection_years + 1):
            ...
            checks.append(
                (
                    ...
                    f"=IF(ABS('Cash Flow'!{col}29-'Balance Sheet'!{col}5)<0.01," f'"PASS","FAIL")',
                    "Cash reconciliation",
                )
            )
    ...
    def _create_documentation(self):
        ...
        documentation = [
            ...
            ("• Net Income", "Flows from income statement to retained earnings and cash flow"),
            ("• Depreciation", "Reduces net income but is added back in cash flow"),
            ("• Working Capital Changes", "Balance sheet changes flow to cash flow adjustments"),
            ("• CapEx", "Cash outflow increases PP&E on balance sheet"),
...
def create_three_statement_model(
    ...
    if output_path is None:
        output_path = (
            f'/mnt/user-data/outputs/{company_name.replace(" ", "_")}_Three_Statement_Model.xlsx'
        )
