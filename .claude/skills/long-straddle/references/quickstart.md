# Long Straddle - Quickstart

**Parent**: [Long Straddle](../SKILL.md) | **Related**: [Strategy Mechanics](strategy-mechanics.md) | [Examples](examples.md)

---

## Overview

The long straddle is a volatility play strategy. It is designed for traders with a volatility market outlook.
