# Long Straddle - Strategy Mechanics

**Parent**: [Long Straddle](../SKILL.md) | **Related**: [Quickstart](quickstart.md) | [Greeks Analysis](greeks-analysis.md)

---

## Position Structure

The long straddle consists of multiple option legs working together to create a specific risk/reward profile.
