# Long Strangle - Strategy Mechanics

**Parent**: [Long Strangle](../SKILL.md) | **Related**: [Quickstart](quickstart.md) | [Greeks Analysis](greeks-analysis.md)

---

## Position Structure

The long strangle consists of multiple option legs working together to create a specific risk/reward profile.
