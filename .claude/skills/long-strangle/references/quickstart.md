# Long Strangle - Quickstart

**Parent**: [Long Strangle](../SKILL.md) | **Related**: [Strategy Mechanics](strategy-mechanics.md) | [Examples](examples.md)

---

## Overview

The long strangle is a volatility play strategy. It is designed for traders with a volatility market outlook.
...
**Market Outlook**: Volatility with clear price targets
