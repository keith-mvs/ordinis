# Iron Condor - Spread Width Optimization

**Parent**: [Iron Condor](../SKILL.md) | **Related**: [Strike Selection](strike-selection.md) | [Examples](examples.md)

---

## Spread Width Optimization for Iron Condor

Choosing the optimal spread width significantly impacts risk/reward, capital efficiency, and probability of profit for iron condor positions.
