# Iron Condor - Quickstart

**Parent**: [Iron Condor](../SKILL.md) | **Related**: [Strategy Mechanics](strategy-mechanics.md) | [Examples](examples.md)

---

## Overview

The iron condor is a multi-leg credit spread strategy. It is designed for traders with a neutral market outlook.
