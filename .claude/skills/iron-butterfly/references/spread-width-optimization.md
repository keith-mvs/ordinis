# Iron Butterfly - Spread Width Optimization

**Parent**: [Iron Butterfly](../SKILL.md) | **Related**: [Strike Selection](strike-selection.md) | [Examples](examples.md)

---

## Spread Width Optimization for Iron Butterfly

Choosing the optimal spread width significantly impacts risk/reward, capital efficiency, and probability of profit for iron butterfly positions.
