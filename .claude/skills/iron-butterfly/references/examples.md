# Iron Butterfly - Examples

**Parent**: [Iron Butterfly](../SKILL.md) | **Related**: [Quickstart](quickstart.md) | [Position Management](position-management.md)

---

## Real-World Iron Butterfly Examples
