# Iron Butterfly - Strike Selection

**Parent**: [Iron Butterfly](../SKILL.md) | **Related**: [Strategy Mechanics](strategy-mechanics.md) | [Examples](examples.md)

---

## Strike Selection Framework

Effective strike selection is critical for iron butterfly success. This guide covers systematic approaches to choosing optimal strikes.
