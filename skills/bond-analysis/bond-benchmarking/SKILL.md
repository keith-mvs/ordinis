...
1. **Select appropriate benchmarks** for various bond types
2. **Calculate spread measures** (G-spread, I-spread, Z-spread)
3. **Perform peer analysis** by sector and rating
4. **Measure excess returns** and attribution
5. **Compute tracking error** and information ratio
6. **Identify relative value** opportunities
7. **Replicate indices** efficiently

## Deliverables

### 1. benchmark_comparison.ipynb
Interactive notebook containing:
- Benchmark yield curve construction
- Spread calculation tools (G/I/Z-spread)
- Peer group comparison framework
- Excess return attribution
- Tracking error analysis
- Relative value screener

### 2. bond_benchmark_report.md
Analysis documentation including:
- Spread-to-benchmark visualization
- Peer comparison tables
- Performance attribution charts
- Relative value ranking
- Portfolio vs. benchmark positioning

## Reference Materials

### Foundational Texts
1. Fabozzi, F. *The Handbook of Fixed Income Securities*
   - Chapter: Performance Attribution

2. Dynkin, L., et al. *Quantitative Management of Bond Portfolios*

### Industry Standards
1. **Bloomberg**: Corporate bond indices methodology
2. **ICE BofA**: Index construction rules
3. **S&P Dow Jones**: Fixed income index methodology

### Data Sources
1. **Bloomberg Terminal**: BVAL benchmark curves
2. **FRED**: Treasury curves and corporate spreads
3. **FINRA TRACE**: Corporate bond transaction data
...
1. Bond: 5% YTM, 7-year maturity. Treasury: 3.5%. Calculate G-spread.
2. Portfolio return: 6%, Benchmark: 5.2%, Tracking error: 1.5%. Calculate IR.
3. Given 10 peer bonds, identify the 3 cheapest by spread-per-duration.
4. Decompose 150 bps excess return into duration (50 bps), spread (75 bps), selection (?).
...
**Previous Skill**: `credit-risk/`  
**Next Skill**: `option-adjusted-spread/`
