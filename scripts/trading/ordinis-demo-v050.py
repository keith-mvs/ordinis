#!/usr/bin/env python
"""
Ordinis Demo v0.50 - Consolidated Live Paper Trading System
...
class LoggingManager:
    ...
    def _setup_loggers(self) -> Dict[str, logging.Logger]:
        ...
        logging.basicConfig(
            ...
            handlers=[
                ...
                logging.FileHandler(self.log_dir / "ordinis_demo.log"),
    ...
    def log_session_start(self):
        ...
        self.loggers["session"].info("ORDINIS DEMO v0.50 - SESSION START")
        self.loggers["session"].info("=" * 80)
...
class OrdinisDemoV050:
    """Ordinis Demo v0.50 - Unified Paper Trading System."""
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            if not self.strategy_loader.load_strategy("configs/strategies/atr_optimized_rsi.yaml"):
                self.logger.warning("Failed to load strategy via StrategyLoader, continuing with config")
    ...
    async def shutdown(self) -> None:
        ...
        self.logger.info("Ordinis Demo v0.50 shutdown complete")
    ...
    def _generate_session_report(self) -> None:
        ...
        report = f"""
{'=' * 80}
ORDINIS DEMO v0.50 - SESSION REPORT
{'=' * 80}
...
async def main():
    """Main entry point for Ordinis Demo v0.50."""
    print()
    print("=" * 80)
    print("ORDINIS DEMO v0.50 - CONSOLIDATED LIVE PAPER TRADING")
    print("=" * 80)
    print()
